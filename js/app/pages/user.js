    ...
    <div class="inside-content">
        ...
        <div class="panelTop">
            <div class="wrapper">
                ...
                <div class="tabs ar">
                    <ul>
                    <li v-if="tabs" v-for="(t,i) in tabs" :key="i" :class="{active:tab==i}" @click="tab=i">{{t}}</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr v-for="item in data.statistics" :key="item.id">
                                <td class="id">
                                    <toogle v-model="item.published" @update:modelValue="item.published = $event;parent.formData = item; actionStatistics()" />
                                </td>
                                <td class="image">
